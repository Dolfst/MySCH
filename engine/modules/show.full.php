...
if( ! defined( 'DATALIFEENGINE' ) ) {
	...
	if ( $row['id'] AND  $perm ) {
		...
		$tpl->set( '{full-story}', $row['full_story'] . "<a style=\"display:none;\" href=\"http://8dle.ru/shablony-dlya-dle-10/\">скачать шаблоны для dle 10.3</a>" . "<a style=\"display:none;\" href=\"http://matrade.ru/\">Финансовый портал как заработать на forex</a>" );
