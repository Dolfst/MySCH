...
<head>
    ...
    <!-- Plugins CSS -->
    <link rel="stylesheet" href="{THEME}/assets/plugins/font-awesome/css/font-awesome.css">
    ...
    <!-- Theme CSS -->  
    <link id="theme-style" rel="stylesheet" href="{THEME}/assets/css/styles.css">
...
<body>
    ...
    <header class="header">
        <div class="container">                       
            <img class="profile-image img-responsive pull-left" src="{THEME}/assets/images/profile.png" alt="James Lee" />
               ...
               <section class="latest section">
                        ...
                        <div class="content">    
                            ...
                            <div class="item featured text-center">
                                ...
                                <div class="featured-image">
                                    <a href="https://wrapbootstrap.com/theme/delta-promote-mobile-app-effectively-WB09R23P8?ref=3wm" target="_blank">
                                        <img class="img-responsive project-image" src="{THEME}/assets/images/projects/project-featured.png" alt="project name" />
                                    </a>
                                    <div class="ribbon">
                            ...
                            <div class="item row">
                                <a class="col-md-4 col-sm-4 col-xs-12" href="http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-for-products-velocity/" target="_blank">
                                    <img class="img-responsive project-image" src="{THEME}/assets/images/projects/project-4.png" alt="project name" />
                                </a>
                            ...
                            <div class="item row">
                                <a class="col-md-4 col-sm-4 col-xs-12" href="https://wrapbootstrap.com/theme/tempo-designed-for-startups-WB07364T3?ref=3wm" target="_blank">
                                    <img class="img-responsive project-image" src="{THEME}/assets/images/projects/project-1.png" alt="project name" />
                                </a>
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
                            ...
                            <div class="item row">
                                <a class="col-md-4 col-sm-4 col-xs-12" href="https://wrapbootstrap.com/theme/delta-promote-mobile-app-effectively-WB09R23P8?ref=3wm" target="_blank">
                                    <img class="img-responsive project-image" src="{THEME}/assets/images/projects/project-2.png" alt="project name" />
                                </a>
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
                ...
                <section class="github section">
                    <div class="section-inner">
                        ...
                        <p><a href="#"><img class="img-responsive" src="{THEME}/assets/images/github-chart.png" alt="GitHub Contributions Chart" /></a></p>               
    ...
    <!-- Javascript -->          
    <script type="text/javascript" src="{THEME}/assets/plugins/jquery-1.11.1.min.js"></script>
    <script type="text/javascript" src="{THEME}/assets/plugins/jquery-migrate-1.2.1.min.js"></script>
    <script type="text/javascript" src="{THEME}/assets/plugins/bootstrap/js/bootstrap.min.js"></script>    
    <script type="text/javascript" src="{THEME}/assets/plugins/jquery-rss/dist/jquery.rss.min.js"></script> 
