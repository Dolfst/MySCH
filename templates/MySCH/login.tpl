			...
			<form method="post" action="">
				<div id="logform" class="radial">
					<ul class="reset nav nav-list">
                        ...
                        <div class="btn-group btn-group-justified"><div class="btn-group"><button class="btn btn-sm btn-primary" onclick="submit();" type="submit" title="Войти"><span>Войти</span></button></div><div class="btn-group"><button class="btn btn-sm btn-info"><a class="btn-info" href="{registration-link}">Регистр.</a></button></div></div>
					</ul>
