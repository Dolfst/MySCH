<div class="base fullstory">
	...
	<div class="mlink">
		<a class="btn btn-primary" href="javascript:history.go(-1)"><b><i class="fa fa-arrow-circle-left"></i>  Вернуться</b></a>	
	</div>
	[group=5]
    <br>
...
[poll]{poll}[/poll]
<div class="pheading">
    <h3 class="lcol"><img src='/templates/MySCH/img/icons/png/Message-128.png' /> Комментарии:</h3>    
	<a class="btn btn-block btn-lg btn-success" href="#" onclick="$('#addcform').toggle();return false;"><b><i class="fa fa-keyboard-o fa-lg"></i> Оставить комментарий</b></a>      
</div>
{addcomments}
{comments}
{navigation}