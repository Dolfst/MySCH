      ...
      <nav class="navbar navbar-inverse" role="navigation">
        ...
        <div class="navbar-header">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
            ...
            <a class="navbar-brand" href="/">My SCH</a>
    </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="/admin.php"><span class="visible-sm visible-xs">Настройки<span class="fui-gear"></span></span><span class="visible-md visible-lg"><span class="fui-gear"></span></span></a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
      </nav>
      <!--END MENU-->
        ...
        <div class="col-xs-6 col-md-3">
          ...
          <div class="demo-col">
              <ul class="nav nav-list">
                ...
                <li>
                  <a href="/index.php?action=mobiledisable">
                    <i class="fa fa-desktop"></i> Полная версия
